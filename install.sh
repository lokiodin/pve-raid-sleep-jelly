...
test -d /etc/pve-raid-sleep-jelly || mkdir /etc/pve-raid-sleep-jelly
test -f /etc/pve-raid-sleep-jelly/pve-raid-sleep-jelly.conf || install -m 644 -v pve-raid-sleep-jelly.conf /etc/pve-raid-sleep-jelly/pve-raid-sleep-jelly.conf
